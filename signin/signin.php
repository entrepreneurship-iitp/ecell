        ...
        if($_POST['subData']==="Sign Up"){
            if($_POST['Password']===$_POST['CPassword']){
				...
				else
				{
					...
					$sql ="INSERT INTO users (`refcode`,`name`,`college`, `webmail`,`password`,`ref_by`, `ca`) VALUES ('$randomString','$name', '$college', '$email', '$password','$ref_by', '$ca')" ;
	...
	<div class="login-html">
		...
		<div class="login-form">
			<div class="sign-up-htm">
				...
				<div class="hr"></div>
				<div class="foot-lnk">
                    <label for="tab-1"><a href="signup.php">Sign Up</a></label>
				</div>
			</div>
